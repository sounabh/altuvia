...
const features = [
  {
    ...
    description:
      "Store and organize all your application documents in one secure location with smart categorization.",
  ...
  },
  {
    ...
    description:
      "Get intelligent suggestions and writing improvements powered by advanced AI technology.",
  ...
  },
  {
    ...
    description:
      "Create dedicated spaces for each school with custom requirements and deadline tracking.",
  ...
  },
  {
    ...
    description:
      "Never miss deadlines with intelligent notifications that adapt to your schedule.",
  ...
  },
  {
    ...
    description:
      "Track changes with automatic saving and version control. Compare and restore drafts easily.",
  ...
  },
  {
    ...
    description:
      "Access curated templates, successful examples, and expert guidance for better applications.",
...
export default function ModernApplicationManagement() {
  ...
  return (
    <div className="min-h-screen bg-[#002147] py-20 px-4 lg:px-12 mt-52 rounded-2xl">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <ScrollReveal direction="up" delay={0.15} duration={0.7}>
            <p className="text-blue-100 text-base max-w-2xl mt-10 mx-auto font-light">
              Streamline your college application process with our
          ...
          {features.map((feature, index) => {
            ...
            return (
              ...
              >
                <div
                  className={`
                    group relative p-6 sm:p-8 rounded-2xl cursor-pointer
        ...
        {/* Decorative Line */}
        <ScrollReveal direction="none" delay={0.6} duration={1}>
