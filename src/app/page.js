...
const ApplicationManagement = dynamic(() => import("./sections/ApplicationMgmt"), { ssr: false });
const Accordions = dynamic(() => import("./sections/Accordion"), { ssr: false });
const ProductShowcase = dynamic(() => import("./sections/Products"), { ssr: false });
const ContactUsPage = dynamic(() => import("./sections/ContactUsPage"), { ssr: false });
const ApplyMateFooter = dynamic(() => import("./sections/Footer"), { ssr: false });
